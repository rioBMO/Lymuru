...
function hasRoundedClass(className: string): boolean {
    return className.split(/\s+/).some((part) => part.startsWith("rounded"));
}
...
export function TidalIcon({ className = "w-4 h-4" }: PlatformIconProps) {
    return (
        <ThemedPlatformIcon
            lightSrc={tidalLightIcon}
            darkSrc={tidalDarkIcon}
            alt="Tidal"
            className={className}
            defaultClassName="rounded-[4px]"
        />
    );
}
...
export function MusicBrainzIcon({ className = "w-4 h-4" }: PlatformIconProps) {
    return (
        <ThemedPlatformIcon
            lightSrc={musicBrainzLightIcon}
            darkSrc={musicBrainzDarkIcon}
            alt="MusicBrainz"
            className={className}
        />
    );
...
export function SonglinkIcon({ className = "w-4 h-4" }: PlatformIconProps) {
    return (
        <ThemedPlatformIcon
            lightSrc={songlinkLightIcon}
            darkSrc={songlinkDarkIcon}
            alt="Songlink"
            className={className}
            defaultClassName="rounded-[3px]"
        />
    );
}
...
export function TidalAvailabilityIcon({
    className = "w-4 h-4",
}: PlatformIconProps) {
    return (
        <svg viewBox="0 0 24 24" className={`${className} fill-current`}>
            <path d="M4.022 4.5 0 8.516l3.997 3.99 3.997-3.984L4.022 4.5Zm7.956 0L7.994 8.522l4.003 3.984L16 8.484 11.978 4.5Zm8.007 0L24 8.528l-4.003 3.978L16 8.484 19.985 4.5Z" />
            <path d="m8.012 16.534 3.991 3.966L16 16.49l-4.003-3.984-3.985 4.028Z" />
        </svg>
    );
}

export function QobuzAvailabilityIcon({
    className = "w-4 h-4",
}: PlatformIconProps) {
    return (
        <svg viewBox="0 0 24 24" className={`${className} fill-current`}>
...
export function AmazonAvailabilityIcon({
    className = "w-4 h-4",
}: PlatformIconProps) {
    return (
        <svg viewBox="0 0 24 24" className={`${className} fill-current`}>
